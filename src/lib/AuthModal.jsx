...
// Flip to true once Google OAuth is configured in Netlify Identity + Google Cloud Console.
// While false, the "Continue with Google" buttons are hidden so users don't see errors.
